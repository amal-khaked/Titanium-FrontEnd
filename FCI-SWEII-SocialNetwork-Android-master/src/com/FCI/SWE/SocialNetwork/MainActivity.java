...
public class MainActivity extends Activity {
	...
	Button login, signUp, sendRequest;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_main);// to show contents
		...
		sendRequest.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent sendRequestIntent=new Intent(getApplicationContext(),SendRequest.class);
